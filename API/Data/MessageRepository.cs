...
public class MessageRepository(DataContext context, IMapper mapper, SentimentAnalysisService sentimentAnalysisService) : IMessageRepository
{
    ...
    {
        message.Sentiment = await sentimentAnalysisService.AnalyzeSentiment(message.Content);
